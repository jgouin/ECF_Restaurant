...
if(($_SESSION['username'] === 'admin')){
    ...
    <div>
        ...
        <p class="text-end"><a href="bookTable.php" class="alert alert-warning">Réservez votre table</a></p>
    </div>

<?php } else { ?>
        <div>
            <p class="mx-4"><a href="newUser.php" class="text-decoration-none" style="color:#ffd900">Créer votre profil</a></p>
            <p class="text-end"><a href="formConnexion.php" class="alert alert-warning">Réservez votre table</a></p>
        </div>
    
<?php } ?>


<h3 class="py-3">Retrouvez ces plats dans notre restaurant</h3>
